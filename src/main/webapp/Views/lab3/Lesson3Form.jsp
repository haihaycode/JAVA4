...
<body>
	<form method="post" class="borderOrange" style="margin: 10px auto;"
		...
		<label>Tên đăng nhập</label> <br> <input class="borderOrange"
			type="text" name="fullname" placeholder="Nhập tên đăng nhập ?">
		<br> <label>Ảnh nhân viên</label> <br> <input
			class="borderOrange" type="file" name="photo_file"> <br>
		<br> <label>Mật khẩu</label><br> <input class="borderOrange"
			type="password" name="password" placeholder="Nhập mật khẩu?">
		<br> <br> <label>Ngày sinh</label><br> <input
			class="borderOrange" type="text" name="birthday"> <br>
		<br> <label>Giới tính</label><br> <input class=""
			type="radio" name="gender" value="true"> Nam <input class=""
			type="radio" name="gender" value="false"> Nữ <br> <br>
		<label>Tình trạng</label><br> Đã kết hôn <input
			class="borderOrange" type="checkbox" name="married"> <br>
		<br> <label>Quốc tịch</label><br> <select name="country"
			class="borderOrange">
			<option value="Vn">Việt Nam</option>
			<option value="Us">United States</option>
		</select> <br> <br> <label>Sở thích</label><br> <input
			name="hobbies" type="checkbox" value="R">Đọc sách <input
			name="hobbies" type="checkbox" value="T">Du lịch <input
			name="hobbies" type="checkbox" value="M">Âm nhạc <input
			name="hobbies" type="checkbox" value="O">Khác<br> <br>
