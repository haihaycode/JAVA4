						...
						<form method="post">
							<div class="form-group">
								<label for="id">Tài khoản:</label> <input type="text"
									class="form-control" required="required" id="id" name="ID">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="fullname">Họ và tên:</label> <input type="text"
									class="form-control" required="required" id="fullname"
									name="fullname">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="radio" name="admin" value="true"> Admin <input
									type="radio" name="admin" value="false" checked> User
							</div>
